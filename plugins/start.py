...
async def start_command(client: Client, message: Message):
    ...
    [
                    ...
                    InlineKeyboardButton('🍁 NETWORK', url='https://t.me/AnimeNexusNetwork/98')
...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton(text="• ⛩️ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ1⛩️", url=client.invitelink2),
            InlineKeyboardButton(text="⛩️ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ2⛩️ •", url=client.invitelink3),
        ],
        [
            InlineKeyboardButton(text="• ⛩️ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ3⛩️ •", url=client.invitelink),
        ]
    ]
    try:
        buttons.append(
